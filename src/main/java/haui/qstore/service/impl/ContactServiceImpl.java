...
import haui.qstore.dao.ContactDao;
...
//		send mail thanks guests
		mailerService.queue(contactModel.getEmail(), "Thông Báo Q-BookStore.com",
				"Kính chào " + name +",<br>"
				+ "Đại diện Q-BookStore shop xin chân thành cảm ơn bạn đã ghé qua và để lại đánh giá ý kiến cá nhân về shop. "

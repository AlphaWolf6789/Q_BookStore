...
import haui.qstore.entity.Order;
import haui.qstore.model.BestSellerModel;
import haui.qstore.model.OrderModel;
import haui.qstore.model.StatisticalOrder;
import haui.qstore.model.StatisticalProductDay;
...
public interface OrderDao extends JpaRepository<Order, Integer>{
	...
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status) FROM Order o WHERE o.status = 0 GROUP BY o.code, o.address.Fullname, o.date, o.status ORDER BY o.date DESC")
	List<OrderModel> listOrderGroupByCodePending();
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status) FROM Order o WHERE o.status = 1 GROUP BY o.code, o.address.Fullname, o.date, o.status ORDER BY o.date DESC")
	List<OrderModel> listOrderGroupByCodeShipping();
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status) FROM Order o WHERE o.status = 2 GROUP BY o.code, o.address.Fullname, o.date, o.status ORDER BY o.date DESC")
	List<OrderModel> listOrderGroupByCodeSuccess();
	
	@Query("SELECT new OrderModel(o.code, o.address.Fullname, sum(o.quality), sum(o.product.price * o.quality), o.date, o.status) FROM Order o WHERE o.status = 3 GROUP BY o.code, o.address.Fullname, o.date, o.status ORDER BY o.date DESC")
	...
	@Query("SELECT new StatisticalProductDay(o.product.code, o.product.name, o.product.price, o.product.quality, sum(o.quality)) FROM Order o WHERE MONTH(GETDATE()) = MONTH(o.date) GROUP BY o.product.code, o.product.name, o.product.price, o.product.quality")

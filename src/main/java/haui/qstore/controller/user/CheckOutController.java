...
import haui.qstore.service.AddressService;
import haui.qstore.service.DiscountService;
import haui.qstore.service.OrderService;
import haui.qstore.service.ParamService;
import haui.qstore.service.ProductService;
import haui.qstore.service.SessionService;
import haui.qstore.service.impl.MailerServiceImpl;
import haui.qstore.service.impl.ShoppingCartServiceImpl;
...
public class CheckOutController {
	...
	public String order(Model model) {
		...
		mailerService.queue(address.getUser().getEmail(), "Đặt Hàng Thành Công Tại Web Q-BookStore",
				"Kính chào " + address.getUser().getFullname() +",<br>"
				+ "Cảm ơn bạn đã mua hàng tại Q-BookStore. Mã đơn hàng của bạn là " + code + "<br>"

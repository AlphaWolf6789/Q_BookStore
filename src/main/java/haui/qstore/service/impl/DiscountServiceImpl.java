...
public class DiscountServiceImpl implements DiscountService {
	...
	public User sendCodeDiscount(Integer discountId, User user) {
		...
		mailerService.queue(user.getEmail(), "Q-BookStore. Thông Tin Khuyến Mãi!",
				"Xin chào bạn " + user.getFullname() +",<br>"
				+ "Q-BookStore xin thông báo đến bạn chương trình. " + discount.getName() + " khi bạn nhập mã <b>" + discount.getCode() + "</b>." + "<br>"
